(function (RequestManager) {
	...
	function Despegar() {
		...
		const SERVICE_BASE_URL = 'http://m.despegar.com.ar/mobile-flights-web/results/',
			PUBLIC_BASE_URL = 'http://www.despegar.com.ar/shop/flights/results/',
	...
	Despegar.prototype = new RequestManager('Despegar', 'Despegar', 1500, 5, 2);
	Despegar.prototype.constructor = Despegar;
	Despegar.prototype.parent = RequestManager.prototype;
